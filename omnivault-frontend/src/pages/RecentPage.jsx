...
import { getRecentContent } from "../store/slices/contentSlice";
...
const RecentPage = () => {
  ...
  // src/pages/RecentPage.jsx (continued)
  useEffect(() => {
    dispatch(getRecentContent({ page: currentPage, size: 12 }));
  ...
  return (
    <Layout>
      <div className="mb-6">
        ...
        <p className="text-gray-500">Your recently added content</p>
      </div>
      ...
      {loading && contents.length === 0 ? (
        ...
        <div className="text-center py-12 bg-white rounded-lg shadow">
          ...
          <p className="mt-1 text-gray-500">Add some content to see it here</p>
        </div>
      ) : (
        <>
